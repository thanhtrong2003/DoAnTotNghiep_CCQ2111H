...
// 			<a className="list-group-item" href="http://localhost:3000/address"> My Address </a>
// 			<a className="list-group-item" href="http://localhost:3000/orders"> My Orders </a>
// 			<a className="list-group-item" href="http://localhost:3000/wishlist"> My wishlist </a>
// 			<a className="list-group-item" href="http://localhost:3000/seller"> My Selling Items </a>
// 			<a className="list-group-item" href="http://localhost:3000/setting"> Settings </a>
...
// 						<div className="aside"><img src={require("../../assets/images/items/1.jpg")} className="border img-sm"/></div>
...
// 				<div className="col-md-6">
// 					<figure className="itemside  mb-3">
// 						<div className="aside"><img src={require("../../assets/images/items/2.jpg")} className="border img-sm"/></div>
// 						<figcaption className="info">
// 							<time className="text-muted"><i className="fa fa-calendar-alt"></i> 12.09.2019</time>
// 							<p>How to be rich</p>
...
// 				<div className="col-md-6">
// 					<figure className="itemside mb-3">
// 						<div className="aside"><img src={require("../../assets/images/items/3.jpg")} className="border img-sm"/></div>
// 						<figcaption className="info">
// 							<time className="text-muted"><i className="fa fa-calendar-alt"></i> 12.09.2019</time>
